...
Extract the content between these markers. This is the **primary** source of decisions.

If no design plan markers exist, use the full PR body as the source material — but apply a higher bar for what counts as a "decision" (skip vague descriptions, feature lists without rationale, etc.).
...
- **Ignore** questions, speculative remarks, casual discussion, and bot comments
