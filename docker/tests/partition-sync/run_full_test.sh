...
echo "========================================"
echo "Irys Partition Data Sync Test"
echo "========================================"
...
# 6. Run the comprehensive partition sync test
echo ""
echo "6. Running comprehensive partition sync test..."
echo "========================================"
cd scripts
python3 partition_sync_test.py
test_result=$?
...
if [ $test_result -eq 0 ]; then
    echo "✓ TEST PASSED: Partition sync test completed successfully!"
else
    echo "✗ TEST FAILED: Partition sync test encountered errors"
fi
