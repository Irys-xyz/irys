...
use crate::node::RethNode;
use crate::node::RethNodeAdapter;
use crate::node::RethNodeAddOns;

use super::{network::NetworkTestContext, payload::PayloadTestContext, rpc::RpcTestContext};
    ...
    AddOns: RethRpcAddOns<Node>,
{
    ...
    // pub fn eth_payload_attributes(timestamp: u64) -> Payload::PayloadBuilderAttributes {
    ...
    //     };
    //     Payload::PayloadBuilderAttributes::try_new(B256::ZERO, attributes, 0).unwrap()
    // }

    // /// Creates a new test node
    // pub async fn new_with_attrs(
    //     node: FullNode<Node, AddOns>,
    //     attributes_generator: impl Fn(u64) -> Payload::PayloadBuilderAttributes + Send + Sync + 'static,
    // ) -> eyre::Result<Self> {
    //     Ok(Self {
