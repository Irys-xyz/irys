...
#[tokio::test]
async fn slow_heavy3_test_auto_stake_pledge(
    #[case] stake: bool,
    #[case] pledges: usize,
    ...
    peer_node.wait_for_block_at_height(tip_height, seconds_to_wait as usize).await?;
    ...
    peer_node.wait_for_block_at_height(head_height, seconds_to_wait as usize).await?;
