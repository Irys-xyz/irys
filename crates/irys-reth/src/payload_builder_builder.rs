...
use crate::evm::ConfigurePdHandle;
        ...
        >,
{
    ...
    async fn build_payload_builder(
        ...
        // Configure evm_config for payload building — use PdHandle for chunk fetching.
        ...
        let evm_config = evm_config.with_pd_handle(self.pd_handle.clone());
