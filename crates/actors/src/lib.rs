...
pub use chunk_ingress_service::{
    ...
    ChunkIngressState, CriticalChunkIngressError, HttpAdmissionGuard, HttpChunkEnqueueError,
    IngressProofError, IngressProofGenerationError, PriorityPendingChunks, enqueue_http_chunk,
};
