use crate::packing_service::types::PackingRequest;
use eyre::eyre;
...
impl PackingService {
    ...
    async fn process_jobs(self, runtime_handle: tokio::runtime::Handle) {
        ...
        'main: loop {
            ...
            let storage_module = next_range.storage_module();
...
pub type PackingSender = tokio::sync::mpsc::Sender<crate::packing_service::types::PackingRequest>;
pub type PackingReceiver =
    tokio::sync::mpsc::Receiver<crate::packing_service::types::PackingRequest>;
